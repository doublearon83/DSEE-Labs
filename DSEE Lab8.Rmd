...
# generate neural network
NN <- neuralnet(l1 + l2 + l3 + l4 + l5 + l6 + l7 + l8 ~ PC1 + PC2 + PC3 + PC4, data = train.NN, hidden = c(13,11,9,7), 
                linear.output = FALSE, act.fct = "logistic", stepmax = 3e+07)
...
if (perc_correct[i] > 0.25) {print(i)} # if model successfully runs - prints iteration
...
<mark style="color:blue">*Due: Tuesday, 11/2 at 1:30 PM, Points: 60 pts.*</mark> 
