...
2) Include all the plots you saved from the data visualization labs, and at least one additional plot that includes prediction intervals.
...
3) Include any statistical results that are required to assess patterns or relationships shown in plots.
...
5) Include any code I asked you to save from previous labs. Include it as an appendix.
