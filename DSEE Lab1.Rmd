...
```{r}
ML_CO2 <- read.csv("C:/Users/17163/Documents/DSEE/Labs/Intro_to_R/MLO_CO2.csv")  
...
Next week, in Part 2 we will learn how to format and manipulate data in a tidy and efficient way. More specifically, in just a few lines of code we will create a data frame with the mean CO2 concentration for ALL years in the dataset, then we will combine those data frame with temperature values from Mauna Loa and graph them using scatterplots!